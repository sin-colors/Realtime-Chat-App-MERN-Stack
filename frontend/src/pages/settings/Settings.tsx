...
function Settings() {
  ...
  return (
    <div className="flex h-screen w-full max-w-4xl overflow-hidden rounded-lg bg-gray-400/60 bg-clip-padding backdrop-blur-lg backdrop-filter sm:h-112.5 md:h-137.5">
